...
- **Kunden-Unterschrift mit Sperre**: Im Tab "Unterschrift" kann der Kunde vor Ort mit dem Finger oder der Maus auf einem Unterschriften-Pad unterzeichnen (samt Name). Sobald unterschrieben ist, gilt der Bericht als abgeschlossen und wird gesperrt – Kopfdaten, Notizen, Zeiten, Material und Fotos lassen sich nicht mehr ändern, eine laufende Stempeluhr wird automatisch beendet, der Status springt auf "Abgeschlossen". Sowohl in der Berichtsliste (Badge, plus eigener Filter "Unterschrieben" neben "Alle/Offen/Abgeschlossen") als auch im Bericht selbst wird "🔒 Unterschrieben" als eigener, genauerer Status angezeigt statt nur "Abgeschlossen". Einziger Weg zurück zum Bearbeiten: die Unterschrift bewusst wieder entfernen (mit Sicherheitsabfrage) – danach ist eine neue Unterschrift nötig. Die Unterschrift erscheint im Word-Export als eigener Abschnitt am Ende des Dokuments
